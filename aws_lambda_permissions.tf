...
resource "aws_lambda_permission" "api_gateway_lambda_authenticate" {
  statement_id  = "AllowExecutionFromAPIGateway"
  action        = "lambda:InvokeFunction"
  function_name = module.lambda_authenticate.function_name
  principal     = "apigateway.amazonaws.com"

  source_arn = "arn:aws:execute-api:${var.region}:${module.global_variables.account_id}:${aws_api_gateway_rest_api.main.id}/*/${module.method_authenticate.http_method}${aws_api_gateway_resource.authenticate.path}"
}
...
resource "aws_lambda_permission" "api_gateway_lambda_authorizer" {
  ...
  source_arn = "arn:aws:execute-api:${var.region}:${module.global_variables.account_id}:${aws_api_gateway_rest_api.main.id}/*"
}
